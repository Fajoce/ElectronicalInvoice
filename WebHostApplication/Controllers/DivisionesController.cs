...
namespace WebHostApplication.Controllers
{
    public class DivisionesController : Controller
    {
        ...
        public DivisionesController(WebHostDbcontext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Boton,Nombre,RutaImagen")] Division division)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Boton,Nombre,RutaImagen")] Division division)
        {
            if (id != division.Id)
            {
                return NotFound();
