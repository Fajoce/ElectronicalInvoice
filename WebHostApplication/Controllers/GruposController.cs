...
namespace WebHostApplication.Controllers
{
    public class GruposController : Controller
    {
        ...
        public GruposController(WebHostDbcontext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdGrupo,Grupo")] Grupos grupos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdGrupo,Grupo")] Grupos grupos)
        {
